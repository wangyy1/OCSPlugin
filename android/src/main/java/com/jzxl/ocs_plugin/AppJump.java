...
public class AppJump implements MethodChannel.MethodCallHandler {
    ...
    public static void registerWith(final PluginRegistry.Registrar registrar) {
        ...
        channel.setMethodCallHandler(new AppJump(channel, registrar.context()));
    }

    public AppJump(MethodChannel methodChannel, Context context) {
    ...
    public void onMethodCall(MethodCall methodCall, MethodChannel.Result result) {
        ...
        try {
            if ("appJump.jump".equals(method)) {
                ...
                Intent intent = context.getPackageManager().getLaunchIntentForPackage(componentName);
